...
static void virtio_9p_pci_class_init(ObjectClass *klass, void *data)
{
    ...
    device_class_add_props(dc, virtio_9p_pci_properties);
}
...
static void virtio_pci_class_init(ObjectClass *klass, void *data)
{
    ...
    device_class_add_props(dc, virtio_pci_properties);
...
static void virtio_blk_pci_class_init(ObjectClass *klass, void *data)
{
    ...
    set_bit(DEVICE_CATEGORY_STORAGE, dc->categories);
    device_class_add_props(dc, virtio_blk_pci_properties);
...
static void virtio_scsi_pci_class_init(ObjectClass *klass, void *data)
{
    ...
    set_bit(DEVICE_CATEGORY_STORAGE, dc->categories);
    device_class_add_props(dc, virtio_scsi_pci_properties);
    pcidev_k->vendor_id = PCI_VENDOR_ID_REDHAT_QUMRANET;
...
static void vhost_scsi_pci_class_init(ObjectClass *klass, void *data)
{
    ...
    set_bit(DEVICE_CATEGORY_STORAGE, dc->categories);
    device_class_add_props(dc, vhost_scsi_pci_properties);
    pcidev_k->vendor_id = PCI_VENDOR_ID_REDHAT_QUMRANET;
    pcidev_k->device_id = PCI_DEVICE_ID_VIRTIO_SCSI;
    pcidev_k->revision = 0x00;
    pcidev_k->class_id = PCI_CLASS_STORAGE_SCSI;
...
static void vhost_vsock_pci_class_init(ObjectClass *klass, void *data)
{
    ...
    device_class_add_props(dc, vhost_vsock_pci_properties);
    pcidev_k->vendor_id = PCI_VENDOR_ID_REDHAT_QUMRANET;
...
static void virtio_balloon_pci_class_init(ObjectClass *klass, void *data)
{
    ...
    set_bit(DEVICE_CATEGORY_MISC, dc->categories);
    device_class_add_props(dc, virtio_balloon_pci_properties);
    pcidev_k->vendor_id = PCI_VENDOR_ID_REDHAT_QUMRANET;
...
static void virtio_serial_pci_class_init(ObjectClass *klass, void *data)
{
    ...
    device_class_add_props(dc, virtio_serial_pci_properties);
    pcidev_k->vendor_id = PCI_VENDOR_ID_REDHAT_QUMRANET;
...
static void virtio_net_pci_class_init(ObjectClass *klass, void *data)
{
    ...
    device_class_add_props(dc, virtio_net_properties);
...
static void virtio_input_pci_class_init(ObjectClass *klass, void *data)
{
    ...
    device_class_add_props(dc, virtio_input_pci_properties);
