...
static x86_def_t builtin_x86_defs[] = {
    ...
    },
    {
        ...
        .features[FEAT_8000_0001_EDX] = PPRO_FEATURES & CPUID_EXT2_AMD_ALIASES,
        .features[FEAT_8000_0001_ECX] = 0,
        .xlevel = 0x80000008,
...
static int cpu_x86_parse_featurestr(x86_def_t *x86_cpu_def, char *features)
{
    ...
    x86_cpu_def->features[FEAT_8000_0001_EDX] |= plus_features[FEAT_8000_0001_EDX];
    x86_cpu_def->features[FEAT_8000_0001_ECX] |= plus_features[FEAT_8000_0001_ECX];
    x86_cpu_def->features[FEAT_C000_0001_EDX] |= plus_features[FEAT_C000_0001_EDX];
    ...
    x86_cpu_def->features[FEAT_8000_0001_EDX] &= ~minus_features[FEAT_8000_0001_EDX];
    x86_cpu_def->features[FEAT_8000_0001_ECX] &= ~minus_features[FEAT_8000_0001_ECX];
    x86_cpu_def->features[FEAT_C000_0001_EDX] &= ~minus_features[FEAT_C000_0001_EDX];
