...
/* Definitions of the cache entries we expose: */
...
/*FIXME: CPUID leaf 0x80000005 is inconsistent with leafs 2 & 4 */
...
/*FIXME: CPUID leaf 0x80000006 is inconsistent with leafs 2 & 4 */
