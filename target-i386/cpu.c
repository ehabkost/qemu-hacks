...
typedef struct model_features_t {
    ...
    uint32_t cpuid;       /* CPUID EAX input value */
...
static X86CPUModelTableEntry builtin_x86_defs[] = {
    {
      ...
      .cpudef = {
        ...
        .feature_words[CPUID_1_ECX] = CPUID_EXT_SSE3 | CPUID_EXT_CX16 |
            CPUID_EXT_POPCNT,
        .feature_words[CPUID_8000_0001_EDX] =
        ...
        .feature_words[CPUID_8000_0001_ECX] = CPUID_EXT3_LAHF_LM |
            CPUID_EXT3_SVM | CPUID_EXT3_ABM | CPUID_EXT3_SSE4A,
        .xlevel = 0x8000000A,
      },
    },
    {
...
static int cpu_x86_fill_host(X86CPUDefinition *def)
{
    ...
    def->feature_words[CPUID_1_EDX] = edx;

    if (kvm_enabled() && def->level >= 7) {
        def->feature_words[CPUID_7_0_EBX] =
                kvm_arch_get_supported_cpuid(kvm_state, 0x7, 0, R_EBX);
    } else {
        def->feature_words[CPUID_7_0_EBX] = 0;
    }
...
void x86_cpu_realize(Object *obj, Error **errp)
{
    ...
    if (env->cpuid_vendor1 == CPUID_VENDOR_AMD_1 &&
        ...
        env->feature_words[CPUID_8000_0001_EDX] &= ~CPUID_EXT2_AMD_ALIASES;
        env->feature_words[CPUID_8000_0001_EDX] |=
